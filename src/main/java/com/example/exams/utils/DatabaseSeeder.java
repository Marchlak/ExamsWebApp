...
public class DatabaseSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        examRepository.save(new Exam(2, 0, false, "Retusz zdjęć rektor PB w Photoshop", LocalDate.now().minusDays(2), LocalTime.now().minusHours(4).withNano(0), LocalDate.now(), LocalTime.now().plusHours(1).withNano(0), subjectRepository.findById(1).get(), students1));
        ...
        examRepository.save(new Exam(4,0,false, "Projektowanie części w SOLIDWORKS", LocalDate.now(), LocalTime.now().minusHours(1).withNano(0), LocalDate.now(), LocalTime.now().plusHours(1).withSecond(0).withNano(0).withNano(0), subjectRepository.findById(1).get(), students1));
        ...
        examRepository.save(new Exam(6,0,false, "Jak zrobić sprawozdanie w MS Paint", LocalDate.now().minusDays(2), LocalTime.now().withSecond(0).withNano(0), LocalDate.now(), LocalTime.now().plusHours(1).withSecond(0).withNano(0), subjectRepository.findById(3).get(), students2));
...
//        studentsRepository.save(new Student(9, groupRepository.getReferenceById(3), "Tomasz", "Adamek", "a", "123", "adamczyk@pb.edu.pl" ));
        ...
        problemRepository.save(new Problem(7, convertImage("/static/images/questionsView.jpg"), "Ocena umiejętności biznesowych na podstawie studiów przypadków", student4, examiner2, "Biznes", examiner2.getFirstname(), "Zakończony"));
        ...
        problemRepository.save(new Problem(12, convertImage("/static/images/createExam.jpg"), "Projektowanie interaktywnego systemu egzaminowania online", student5, examiner3, "Informatyka", examiner3.getFirstname(), "Rozpatrywany"));
        problemRepository.save(new Problem(13, convertImage("/static/images/questionsView.jpg"), "Badanie wpływu stresu egzaminacyjnego na wyniki studentów", student6, examiner1, "Psychologia", examiner1.getFirstname(), "Zakończony"));
        problemRepository.save(new Problem(14, convertImage("/static/images/editExam.jpg"), "Rozwój metod oceny kreatywności w egzaminach artystycznych", student6, examiner2, "Sztuka", examiner2.getFirstname(), "Rozpatrywany"));
        ...
        problemRepository.save(new Problem(16, convertImage("/static/images/createExam.jpg"), "Tworzenie systemu zapobiegającego oszustwom na egzaminach online", student2, examiner3, "Informatyka", examiner3.getFirstname(), "Rozpatrywany"));
